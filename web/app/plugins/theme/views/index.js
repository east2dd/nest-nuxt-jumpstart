...
Vue.component('contacts-profile', require('./contacts/contacts-profile').default);
...
Vue.component('crypto-kyc-application', require('./crypto/kyc-application').default);
...
Vue.component('ecommerce-product-detail', require('./ecommerce/product-detail').default);
...
Vue.component('ecommerce-add-product', require('./ecommerce/add-product').default);
...
Vue.component('icons-materialdesign', require('./icons/materialdesign').default);
